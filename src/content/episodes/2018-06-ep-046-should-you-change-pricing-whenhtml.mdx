...
description: 'Steve''s drinking a Founder''s All Day IPA and drinking a Coke that
  says Futbol Fan on it because we are talking about the World Cup. Then it''s on
  to topics: Is it okay to take photos using natural disasters as a backdrop? Does
  that romanticize the horrific disaster? Or is that considered profiting off someone
  else''s pain and devastation?'
