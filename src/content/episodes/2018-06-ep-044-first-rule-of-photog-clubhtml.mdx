...
description: First up this week Dustin and Steve discuss the Royal Wedding, only two
  weeks late! Then we follow up on Dustin's hotel room drama. After that it's on to
  the main show.
